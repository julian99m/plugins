 ...
 */
export function getInventory<ThrowOnError extends boolean = true>(options: Options<GetInventoryOptionsSchemaType, ThrowOnError> = {}): Promise<RequestResult<GetInventoryResponsesSchemaType, ThrowOnError>> {
