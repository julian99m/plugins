...
): UndefinedInitialDataOptions<GetPetByIdStatus200, ResponseErrorConfig<GetPetByIdStatus400>, GetPetByIdStatus200, GetPetByIdSuspenseQueryKey> & {
  queryKey: DataTag<GetPetByIdSuspenseQueryKey, GetPetByIdStatus200, ResponseErrorConfig<GetPetByIdStatus400>>
} {
  const queryKey = getPetByIdSuspenseQueryKey({ path })
  return queryOptions<GetPetByIdStatus200, ResponseErrorConfig<GetPetByIdStatus400>, GetPetByIdStatus200, GetPetByIdSuspenseQueryKey>({
    queryKey,
